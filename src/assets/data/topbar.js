...
export const notificationsData = [
  {
    from: 'Arnav Mehta',
    content: 'Booked "Women’s Special Rajasthan Tour" — please verify the booking details.',
    icon: avatar1
  },
  {
    from: 'Amit Sharma',
    content: 'Sent an enquiry: “Do you have any upcoming Goa packages?”'
  },
  {
    from: 'Sneha Kulkarni',
    content: 'Added a review on "Kashmir Paradise Tour" — ⭐⭐⭐⭐⭐',
    icon: avatar3
  },
  {
    from: 'Tour Manager',
    content: 'Updated itinerary for “Leh-Ladakh Adventure Tour”.',
    icon: avatar5
  },
  {
    from: 'Payment Gateway',
    content: 'Payment received for booking ID #TR2456 — ₹45,000 confirmed.'
  }
];
