...
const CategoryList = async () => {
  const categoryData = await getPackageData()
  return (
    <Row>
      <Col xl={12}>
        <Card>
          <CardHeader className="d-flex flex-wrap justify-content-between align-items-center gap-1">
            ...
            <input type="text" className="form-control w-auto" placeholder="Search categories..." />
                    ...
                    <tr key={idx}>
                      ...
                      <td>
                        <div className="d-flex align-items-center gap-2">
                          <p className="text-dark fw-medium fs-15 mb-0">{item.category}</p>
                        </div>
                      </td>
                      <td>{item.slug}</td>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <Link href="/category/category-edit" className="btn btn-soft-primary btn-sm">
