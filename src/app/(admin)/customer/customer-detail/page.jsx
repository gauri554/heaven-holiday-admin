        ...
        <div className="table-responsive">
          <table className="table mb-0">
            <tbody>
              <tr>
                <td className="px-0">
                  <p className="d-flex mb-0 align-items-center gap-1 fw-semibold text-dark">Customer ID : </p>
                </td>
                <td className="text-dark fw-medium px-0">#AC-278699</td>
              </tr>
              <tr>
                <td className="px-0">
                  <p className="d-flex mb-0 align-items-center gap-1 fw-semibold text-dark"> E-Ticket <br/> Email : </p>
                </td>
                <td className="text-dark fw-medium px-0">michaelaminer@dayrep.com</td>
              </tr>
              <tr>
                <td className="px-0">
                  <p className="d-flex mb-0 align-items-center gap-1 fw-semibold text-dark"> Travel Address : </p>
                </td>
              ...
              <tr>
                <td className="px-0">
                  <p className="d-flex mb-0 align-items-center gap-1 fw-semibold text-dark"> Latest E-Ticket Id : </p>
                </td>
            ...
            <Col lg={6}>
              <Card>
                <CardBody className=" text-center">
                  ...
                  <p className="mb-0">Collect reward points with each booking.</p>
                </CardBody>
                <CardFooter className="border-top gap-1 hstack">
                  <Link href="" className="btn btn-primary w-100">
                    Earn Point
