...
import tourImg from "@/assets/images/products/package1.jpg";
export const popularProfileData = [{
  ...
  export const popularTourData = [
    {
      image: tourImg,
      title: "Rajsthan Marwad - Pune",
      destinations: "6 cities",
      duration: "8 Days",
      price: "45,000",
      description: "Explore the beauty of Rajsthan with guided tours, and scenic travel experiences."
    },
    {
      image: tourImg,
    ...
    destinations: "6 cities",
      duration: "6 Days",
      price: "35,000",
      description: "Discover the highlights of rajsthan and experience authentic local hospitality."
    }
  ];