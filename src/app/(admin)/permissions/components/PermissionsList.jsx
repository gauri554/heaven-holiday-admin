        ...
        <tr>
          <th style={{ width: 20 }}>
            <div className="form-check">
              <input type="checkbox" className="form-check-input" id="selectAllPermissions" />
      ...
      <tbody>
        {permissionsData.map((item, idx) => (
          <tr key={idx}>
            <td>
              <div className="form-check">
                <input type="checkbox" className="form-check-input" id={`permCheck${idx}`} />
                <label className="form-check-label" htmlFor={`permCheck${idx}`}>&nbsp;</label>
              </div>
            </td>
