  ...
  return <Card>
      ...
      <CardBody>
        <Row>
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} name="title" label="Subcategory Title" placeholder="Enter Title" />
            </div>
          </Col>
          <Col lg={6}>
            ...
            <ChoicesFormInput className="form-control" id="crater" data-choices data-choices-groups data-placeholder="Select Creater">
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="parentcategory" label="Parent Category" placeholder="Enter Parent Category" />
            </div>
          </Col>
          <Col lg={6}>
            <div className="mb-3">
  ...
  return <Card>
      ...
      <CardBody>
        <Row>
          ...
          <Col lg={6}>
            <div className="mb-3">
              <TextFormInput control={control} type="text" name="metaID" label="Meta ID" placeholder="#*****" />
            </div>
          </Col>
          <Col lg={12}>
            <div className="mb-0">
