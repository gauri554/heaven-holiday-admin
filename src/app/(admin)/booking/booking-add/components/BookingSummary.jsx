...
const BookingSummary = () => {
  const packageData = useFetchData(getAllBooking);
  const {
    isTrue,
    toggle
  } = useToggle();
  return <>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Booking Summary</CardTitle>
        </CardHeader>
        <CardBody>
          <div className="table-responsive">
            {packageData?.slice(0, 4).map((item, idx) => <div className="d-flex align-items-center gap-3 mb-4" key={idx}>
                <div className="rounded bg-light avatar d-flex align-items-center justify-content-center">
                  {item.image && <Image src={item.image} alt="product" className="avatar" />}
                </div>
                <div>
                ...
                <div className="ms-auto text-end">
                  <p className="text-dark fw-medium mb-1">{item.totalAmt}</p>
            ...
            <table className="table mb-0">
              <tbody>
                <tr>
                  <td className="px-0">
                    <p className="d-flex mb-0 align-items-center gap-1">
                      <IconifyIcon icon="solar:clipboard-text-broken" /> Tour Price :{' '}
                    </p>
                  </td>
                  <td className="text-end text-dark fw-medium px-0">{currency}45000</td>
                </tr>
                <tr>
                  <td className="px-0">
                    <p className="d-flex mb-0 align-items-center gap-1">
                ...
                <tr>
                  <td className="px-0">
                    <p className="d-flex mb-0 align-items-center gap-1">
                      <IconifyIcon icon="solar:kick-scooter-broken" className="align-middle" /> Taxes/Services Charge :{' '}
                    </p>
                  </td>
        ...
        <CardFooter className="bg-light-subtle">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div>
              <p className="fw-medium text-dark mb-0">{currency}45600</p>
            </div>
          </div>
          <Alert className="alert-warning alert-icon mt-3 mb-0" role="alert">
            <div className="d-flex align-items-center">
              ...
              <div className="flex-grow-1">Estimated Departure by 25 April, 2024</div>
            </div>
          </Alert>
        </CardFooter>
      </Card>
      <div className="main-btn my-4 text-end">
        <Link href="/booking/booking-add" className="btn btn-danger">
          Back To Bookings
        </Link>
        &nbsp;
                ...
                <Row className="align-items-center">
                  <Col lg={12}>
                    <div className="check-icon text-center">
                      ...
                      <p className="mb-1">Your tour booking has been successfully created.</p>
                      <p>
                        <span className="text-dark fw-medium">Booking Id</span> : #0758267/90
                      </p>
                    </div>
                    <hr />
                    ...
                    <div className="row justify-content-between mt-3 align-items-center">
                      <Col lg={6} xs={6}>
                        <span className="fw-semibold text-muted fs-14">Booked By</span>
                    ...
                    <div className="row justify-content-between mt-3 align-items-center">
                      <Col lg={6} xs={6}>
                        ...
                        <h5 className="fw-medium mt-1">INR45000</h5>
                      </Col>
                      <Col lg={4} xs={6} className="text-end">
            ...
            <div data-bs-theme="dark">
              <CardFooter className="d-flex align-items-center border-0 bg-body gap-3 rounded">
                ...
                <div className="d-block">
                  <p className="text-white fw-semibold mb-0">Tour Package</p>
                  <p className="mb-0 text-white-50">
                    <span>7 Days / 6 Nights - Rajsthan Heritage Tour</span>
                  </p>
                </div>
