...
import { bookingData } from '../../../booking/booking-list/data';
...
const BookingDataCardPage = () => {
  return <Row>
      {bookingData.map((item, idx) => <Col md={6} xl={3} key={idx}>
          <BookingCard {...item} />
        </Col>)}
    </Row>;
};
export default BookingDataCardPage;